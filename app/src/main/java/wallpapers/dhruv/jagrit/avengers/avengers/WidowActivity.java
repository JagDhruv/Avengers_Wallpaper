 ...
 */
public class WidowActivity extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int positon = intent.getIntExtra(NextActivity.WIDOW_ID,6);
        ImageAdapter adapter = new ImageAdapter(this, NextActivity.avengers6);
        ImageView imageView = (ImageView) findViewById(R.id.imageView123);
        imageView.setImageResource(intent.getIntExtra(NextActivity.WIDOW_ID, 6));
