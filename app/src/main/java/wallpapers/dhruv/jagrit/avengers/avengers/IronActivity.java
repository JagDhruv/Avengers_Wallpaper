...
public class IronActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int positon = intent.getIntExtra(NextActivity.IRON_ID,4);
        ImageAdapter adapter = new ImageAdapter(this, NextActivity.avengers2);
        ImageView imageView = (ImageView) findViewById(R.id.imageView123);
        imageView.setImageResource(intent.getIntExtra(NextActivity.IRON_ID, 4));
