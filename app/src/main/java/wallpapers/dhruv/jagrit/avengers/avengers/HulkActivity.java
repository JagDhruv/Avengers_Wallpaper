 ...
 */
public class HulkActivity extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int positon = intent.getIntExtra(NextActivity.HULK_ID,3);
        ImageAdapter adapter = new ImageAdapter(this, NextActivity.avengers4);
        ImageView imageView = (ImageView) findViewById(R.id.imageView123);
        imageView.setImageResource(intent.getIntExtra(NextActivity.HULK_ID, 3));
