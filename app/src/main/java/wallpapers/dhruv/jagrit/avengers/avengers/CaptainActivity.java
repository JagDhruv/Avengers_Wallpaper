 ...
 */
public class CaptainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int positon = intent.getIntExtra(NextActivity.CAP_ID,1);
        ImageAdapter adapter = new ImageAdapter(this, NextActivity.avengers1);
        ImageView imageView = (ImageView) findViewById(R.id.imageView123);
        imageView.setImageResource(intent.getIntExtra(NextActivity.CAP_ID, 1));
