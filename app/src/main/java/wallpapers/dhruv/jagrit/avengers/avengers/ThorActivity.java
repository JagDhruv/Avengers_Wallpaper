 ...
 */
public class ThorActivity extends Activity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final int positon = intent.getIntExtra(NextActivity.THOR_ID,5);
        ImageAdapter adapter = new ImageAdapter(this, NextActivity.avengers3);
        ImageView imageView = (ImageView) findViewById(R.id.imageView123);
        imageView.setImageResource(intent.getIntExtra(NextActivity.THOR_ID, 5));
